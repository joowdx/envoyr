...
<section class="min-h-screen text-white flex items-center justify-center px-6 py-20 dark:bg-neutral-900 text-left">
  <div class="max-w-2xl" data-aos="fade-right" data-aos-delay="100">
    ...
    <p class="text-lg mb-4 text-white">Envoyr makes document tracking seamless, efficient, and fully transparent.</p>
    <p class="text-lg mb-8 text-white">Powered by smart QR codes.</p>
...
<section id="features" class="py-20 bg-black dark:bg-neutral-800 px-6">
  ...
  <div class="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
    <div class="bg-black text-primary p-8 rounded-xl shadow-md hover:shadow-lg transition" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="bg-black text-primary p-8 rounded-xl shadow-md hover:shadow-lg transition" data-aos="fade-up" data-aos-delay="200">
    ...
    <div class="bg-black text-primary p-8 rounded-xl shadow-md hover:shadow-lg transition" data-aos="fade-up" data-aos-delay="300">
...
<!-- CTA -->
<section class="bg-gradient-to-br from-black via-neutral-900 to-black text-white py-20 text-center px-6" data-aos="zoom-in" data-aos-delay="100">
...
<!-- Footer -->
<footer class="bg-neutral-950 text-neutral-300 dark:bg-neutral-900 text-center py-6" data-aos="fade-in" data-aos-delay="100">
